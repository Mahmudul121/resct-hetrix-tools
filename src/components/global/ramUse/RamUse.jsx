...
import CurveAreaChart from "../charts/CurveAreaChart";
  ...
  return (
    <div className="ram-block home-block">
      ...
      <div className="d-flex align-items-center gap-2 mb-4">
        <Button name={"RAM"} size="sm" variant="primary" />
        <Button name={"SWAP"} size="sm" variant="light" />
      </div>
      <FilterList />
      <CurveAreaChart options={options} series={series} />
